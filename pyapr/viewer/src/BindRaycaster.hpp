...
#ifndef PYLIBAPR_BINDRAYCASTER_HPP
#define PYLIBAPR_BINDRAYCASTER_HPP
...
void AddRaycaster(pybind11::module &m,  const std::string &modulename) {
...
#endif //PYLIBAPR_BINDRAYCASTER_HPP
